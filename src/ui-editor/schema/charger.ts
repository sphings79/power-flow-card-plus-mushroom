...
/**
 * Editor page for the external charging source (V2L, generator, …).
 *
 * `entity` may be left empty when the individual charging sources are configured
 * in the list below the form — the card then aggregates them into this node.
 */
export const chargerSchema = [
  {
    name: "entity",
    selector: { entity: {} },
  },
